...
1.5. Go to https://snap.berkeley.edu/
2. Press the Run Snap! Now button.
...
3. You can either drag the file onto the Snap window, or you can import it, up to you. Follow the steps below to import it. If not, skip to step 6.
3.5. In the top left of the screen, hit the small file icon.
   <img width="441" height="124" alt="image" src="https://github.com/user-attachments/assets/cfc43d3d-a664-4fa8-86ce-1012f820df04" />
4. Find import, and select it.
  <img width="276" height="314" alt="image" src="https://github.com/user-attachments/assets/da8aed23-a879-445f-8ea0-aa8e1405f9af" />
5. Find the file you downloaded, load it, and you have my project now!
6. To run the program, click the green flag in the top right corner of the window.
